...
## Features
* **Massive Library:** Over 190+ classic dad jokes dynamically loaded into memory from a plain text file.
...
* **Clay Integration:** Configure font sizes, daily schedules, timeouts, and alert styles directly from your phone.
